...
clueai_mt_weights_all = clueai_mt_weights + [("pretrain_mt_decoder", sum_weight), ("pretrain_mt_encoder", sum_weight)]
...
#clueai_corpus_mt_weights = [("clueai_corpus", 2*sum_weight)]  + clueai_mt_weights_all
