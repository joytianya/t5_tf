...
task_weights_169["person_role"] = 10000
task_weights = task_weights_169

limit_num = 10000000
task_glob_num_str = "[0][0][0][0-1][0-9][0-9]"
#task_glob_num_str = "*"
...
logging.info(f"all_task size:{len(task_weights_169)}, train task size:{len(task_weights)}")
# 各个数据集注册任务以及分配权重
i = 0
...
dataset_name = "*"
pretrain_task_glob_num_str = "[0][0][0][0-1][0-9][0-9]"
